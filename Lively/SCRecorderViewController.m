...
#define kVideoPreset AVCaptureSessionPreset3840x2160
...
- (void)viewWillAppear:(BOOL)animated {
     hidetabbartimer = [NSTimer scheduledTimerWithTimeInterval:0.1 target:self selector:@selector(hideTabBar) userInfo:nil repeats:YES];
