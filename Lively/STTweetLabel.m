...
- (void)setupLabel {
    ...
    _attributesText = @{NSForegroundColorAttributeName: [UIColor grayColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.0]};
    _attributesHandle = @{NSForegroundColorAttributeName: [UIColor purpleColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.0]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [UIColor purpleColor], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.0]};
