...
@interface homeViewController ()
{
    ...
    NSTimer *videoCheckTimer,*timer1,*timer2,*timer3;
    int play;
    int duration;
    int options;
...
@property (readwrite, retain) AVQueuePlayer* mPlayer;
...
- (void)viewDidLoad {
    ...
    oldFrame=collectionV.frame;
    collectionV.bounces=true;
    collectionV.decelerationRate=UIScrollViewDecelerationRateFast;
    //collectionV.scrollView.decelerationRate = UIScrollViewDecelerationRateFast;

    [LoaderViewController show:self.view animated:YES];
    
    imgPull.animationImages = [[NSArray alloc] initWithObjects:
                               ...
                               [UIImage imageNamed:@"Comp 1_00013.png"],
                               [UIImage imageNamed:@"Comp 1_00014.png"],
                               [UIImage imageNamed:@"Comp 1_00015.png"],
                               [UIImage imageNamed:@"Comp 1_00016.png"],
                               [UIImage imageNamed:@"Comp 1_00017.png"],
                               [UIImage imageNamed:@"Comp 1_00018.png"],
                               [UIImage imageNamed:@"Comp 1_00019.png"],
                               [UIImage imageNamed:@"Comp 1_00020.png"],
                               [UIImage imageNamed:@"Comp 1_00021.png"],
                               [UIImage imageNamed:@"Comp 1_00022.png"],
                               [UIImage imageNamed:@"Comp 1_00023.png"],
                               [UIImage imageNamed:@"Comp 1_00024.png"],
                               [UIImage imageNamed:@"Comp 1_00025.png"],
                               [UIImage imageNamed:@"Comp 1_00026.png"],
                               [UIImage imageNamed:@"Comp 1_00027.png"],
                               [UIImage imageNamed:@"Comp 1_00028.png"],
                               [UIImage imageNamed:@"Comp 1_00029.png"],
                               [UIImage imageNamed:@"Comp 1_00030.png"],
                               [UIImage imageNamed:@"Comp 1_00031.png"],
                               [UIImage imageNamed:@"Comp 1_00032.png"],
                               [UIImage imageNamed:@"Comp 1_00033.png"],
                               [UIImage imageNamed:@"Comp 1_00034.png"],
                               [UIImage imageNamed:@"Comp 1_00035.png"],
                               [UIImage imageNamed:@"Comp 1_00036.png"],
                               [UIImage imageNamed:@"Comp 1_00037.png"],
                               [UIImage imageNamed:@"Comp 1_00038.png"],
                               [UIImage imageNamed:@"Comp 1_00039.png"],
                               [UIImage imageNamed:@"Comp 1_00040.png"],
                               [UIImage imageNamed:@"Comp 1_00041.png"],
                               [UIImage imageNamed:@"Comp 1_00042.png"],
                               [UIImage imageNamed:@"Comp 1_00043.png"],
                               [UIImage imageNamed:@"Comp 1_00044.png"],
                               [UIImage imageNamed:@"Comp 1_00045.png"],
                               [UIImage imageNamed:@"Comp 1_00046.png"],
                               [UIImage imageNamed:@"Comp 1_00047.png"],
                               [UIImage imageNamed:@"Comp 1_00048.png"],
                               [UIImage imageNamed:@"Comp 1_00049.png"],
                               [UIImage imageNamed:@"Comp 1_00050.png"],
                               [UIImage imageNamed:@"Comp 1_00051.png"],
                               [UIImage imageNamed:@"Comp 1_00052.png"],
                               [UIImage imageNamed:@"Comp 1_00053.png"],
                               [UIImage imageNamed:@"Comp 1_00054.png"],
                               [UIImage imageNamed:@"Comp 1_00055.png"],
                               [UIImage imageNamed:@"Comp 1_00056.png"],
                               [UIImage imageNamed:@"Comp 1_00057.png"],
                               [UIImage imageNamed:@"Comp 1_00058.png"],
                               [UIImage imageNamed:@"Comp 1_00059.png"],
                               nil];
    imgPull.animationDuration=3;
    
    
    
    
    if([start isEqualToString:@"find"])
    {
    ...
    else if ([start isEqualToString:@"skip"])
    {
    ...
    if(splash != 1)
    {
    imgSplash=[[UIImageView alloc]initWithFrame:[ [ UIScreen mainScreen ] bounds ]];
    imgSplash.image=[UIImage imageNamed:@"splash@2x.png"];
    [[(AppDelegate *)[[UIApplication sharedApplication] delegate] window] addSubview:imgSplash];
    }
...
-(void)getAllvideos
{
    NSString *d;
    if(postArr.count>0)
        d=[NSString stringWithFormat:@"%d",(int)postArr.count];
    else
        d=@"10";
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@/GetUserPost/%@",WEBURL1,url];
...
-(void)stopPull
{
    ...
    [UIView setAnimationDuration:0.5];
     collectionV.scrollEnabled = true;
    collectionV.frame=oldFrame;
    collectionV.alpha=1.0;
    [UIView commitAnimations];
    [imgPull stopAnimating];
    [collectionV setUserInteractionEnabled:YES];
...
-(void)getShowMoreData
{
    ...
    {
        apicall=0;
        NSString *url=[NSString stringWithFormat:@"%@/%@/%@",userid,min,max];
        NSLog(@"hello%@",url);
        api_obj=[[APIViewController alloc]init];
...
-(void)getShowMoreDataResult:(NSDictionary *)dict_Response
{
    ...
    else
    {
        if([[[dict_Response objectForKey:@"response"]valueForKey:@"status" ] integerValue]==200)
        {
            ...
            {
                if([[dict_Response valueForKey:@"posts"] count]>0)
                {
                    for(int i=0;i<[[dict_Response valueForKey:@"posts"] count];i++)
                    {
                        [postArr addObject:[dict_Response valueForKey:@"posts"][i]];
                        
                    }
                    if([[dict_Response valueForKey:@"posts"] count])
                    {
                        ...
                        //[self saveHomePagePostsInDataBase:postArr];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(scrollTableOnNotification) name:@"home" object:nil];
    
    

    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(StopVideoOnScreenChange) name:@"StopVideo" object:nil];
    [self getAllvideos];

    if(postArr.count>0)

       timer2= [NSTimer scheduledTimerWithTimeInterval:0.8 target:self selector:@selector(scrollTableOnNotification) userInfo:nil repeats:NO];
    ...
    else
    {
        if([[[dict_Response objectForKey:@"response"]valueForKey:@"status" ] integerValue]==200)
        {
            ...
            if([screenName isEqualToString:@"home"])
            {
                ...
                if(imgSplash!=nil)
                {
                    path =[[NSBundle mainBundle] pathForResource:@"HomeScreenSound" ofType:@"mp3"];
                    url = [NSURL fileURLWithPath:path];
                    player1 = [[AVAudioPlayer alloc] initWithContentsOfURL:url error:NULL];
                ...
                //[self saveHomePagePostsInDataBase:postArr];
                //[self addDataOnScrollView];
                timer1=[NSTimer scheduledTimerWithTimeInterval:1.0 target:self selector:@selector(reloadTable) userInfo:nil repeats:NO ];
                if(postArr.count==0)
                {
                    if(imgSplash!=nil)
                    {
...
{
    [collectionV reloadData];
    //[NSTimer scheduledTimerWithTimeInterval:2.0 target:self selector:@selector(scrollTableOnNotification) userInfo:nil repeats:NO];
}
-(void)getAllVideosResult1:(NSDictionary *)dict_Response
{
    NSLog(@"%@",dict_Response);
    [LoaderViewController remove:self.view animated:YES];
    if (dict_Response==NULL)
    ...
    else
    {
        if([[[dict_Response objectForKey:@"response"]valueForKey:@"status" ] integerValue]==200)
        {
            if([screenName isEqualToString:@"home"])
            {
                ...
                apicall=1;
                if(postArr.count>0)
               timer2= [NSTimer scheduledTimerWithTimeInterval:2.0 target:self selector:@selector(scrollTableOnNotification) userInfo:nil repeats:NO];
            }
...
-(void)getNotificationCountResult:(NSDictionary*)dict_Response
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@/Notification.svc/ClearBadgeCount/%@",appUrl,userid];
...
-(void)downloadstoryvideos:(NSMutableDictionary*)dictTemp
{
    ...
    if(![str isEqualToString:@""])
    {
        ...
        if(fileExists && asset.playable)
        {
            [playableDict setObject:@"YES" forKey:[NSString stringWithFormat:@"%lu",(unsigned long)[postArr indexOfObject:dictTemp]]];
            [self btnImagesClick:0];
...
//        [api_obj HidePost:@selector(HidePostResult:) tempTarget:self :[dict valueForKey:@"postid"]];
        ...
        NSString *urlString=[NSString stringWithFormat:@"%@/HidePost/%@/%@",WEBURL1,userid,[dict valueForKey:@"postid"]];
        ...
        [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operationlk, id responseObject) {
            
            NSString *jsonString = operationlk.responseString;
            NSData *JSONdata = [jsonString dataUsingEncoding:NSUTF8StringEncoding];
            ...
            if (JSONdata != nil) {
                ...
                [self HidePostResult:JSON];
                
            }
            
        } failure:^(AFHTTPRequestOperation *operationl, NSError *error) {
            
            NSLog(@"error: %@",  operationl.responseString);
...
//            for (NSManagedObject *obj in objects11) {
//                
//                [obj setValue:[NSNumber numberWithInt:1] forKey:@"hide"];
//                [context save:&error];
//                
//            }
//        }
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    celll=nil;
    cellToActivate=nil;
    cellToDeactivate=nil;
    [cellToActivate.videoView.player pause];
    [cellToDeactivate.videoView.player pause];
    cellToDeactivate.videoView.player=nil;
    cellToActivate.videoView.player=nil;
    celll.videoView.player=nil;
    [cellToDeactivate.activity stopAnimating];
    cellToDeactivate.activity.hidden=YES;
    [cellToActivate.activity stopAnimating];
    cellToActivate.activity.hidden=YES;
...
-(void)closeFullView1:(UIButton*)btn
{
    ...
    player=nil;
    //
    //    int c=collectionV.bounds.origin.y;
    //    CGRect scrollBounds = collectionV.bounds;
    //    scrollBounds.origin = CGPointMake(0, c+100);
    //    collectionV.bounds = scrollBounds;
    //
...
- (void)handleDoubleTap:(UIGestureRecognizer *)indexPath {
    ...
    if([[selectedFeed valueForKey:@"like_status"]boolValue])
    {
        ...
        UIButton *v1 = (UIButton *)[collectionV viewWithTag:900+indexPost];
        [v1 setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        [[postArr objectAtIndex:indexPost] setValue:@"0" forKey:@"like_status"];
        
        
        
        UIButton *v = (UIButton *)[collectionV viewWithTag:6700+indexPost];
        [v setTitle:[NSString stringWithFormat:@"%d",[[v titleForState:UIControlStateNormal ]intValue]-1] forState:UIControlStateNormal];
        api_obj=[[APIViewController alloc]init];
        [api_obj likeOnFeed:@selector(getlikeresult:) tempTarget:self :[selectedFeed objectForKey:@"postid"] :st];
    ...
    else
    {
        ...
        UIButton *v1 = (UIButton *)[collectionV viewWithTag:900+indexPost];
        [[postArr objectAtIndex:indexPost] setValue:@"1" forKey:@"like_status"];
        
        [v1 setImage:[UIImage imageNamed:@"like_filled"] forState:UIControlStateNormal];
    ...
    if(!decelerate)
    {
        ...
        if([[playableDict valueForKey:[NSString stringWithFormat:@"%d",currentplayingVideo]]isEqualToString:@"YES"])
        {
            ...
            dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^(void) {
                ...
                if(fileExists && asset.playable && collectionV.frame.origin.y<80)
                {
                    if(play == 1)
                    {
                    [cellToActivate.activity stopAnimating];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if(collectionV.contentOffset.y>10)
    {
    ...
    if(scrollView.contentOffset.y<-50)
    {
        ...
        path =[[NSBundle mainBundle] pathForResource:@"PullToRefresh" ofType:@"mp3"];
        
        url1 = [NSURL fileURLWithPath:path];
        player1 = [[AVAudioPlayer alloc] initWithContentsOfURL:url1 error:NULL];
        [player1 setVolume:5.0];
        [player1 play];
        ...
        if(postArr.count>0)
        {
            ...
            if(apicall==1)
            {
                ...
                [collectionV setUserInteractionEnabled:NO];
                [imgPull startAnimating];
                
                [UIView beginAnimations:@"Zoom" context:NULL];
                [UIView setAnimationDuration:0.5];
                if(iphone4 || iphone5)
                {
                    [collectionV setFrame:CGRectMake(0, 210, collectionV.frame.size.width, collectionV.frame.size.height)];
                }
                else if(iphone6)
                {
                    [collectionV setFrame:CGRectMake(0, 246, collectionV.frame.size.width, collectionV.frame.size.height)];
                }
                else
                {
                    [collectionV setFrame:CGRectMake(0, 270, collectionV.frame.size.width, collectionV.frame.size.height)];
                }
                collectionV.alpha=0.5;
                [UIView commitAnimations];
                collectionV.scrollEnabled = false;
                [NSTimer scheduledTimerWithTimeInterval:2 target:self selector:@selector(stopPull) userInfo:nil repeats:NO];
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView{
    ...
    if(postArr.count>0)
    {
        ...
        timer3=[NSTimer scheduledTimerWithTimeInterval:0.8 target:self selector:@selector(scrollTableOnNotification) userInfo:nil repeats:NO];
         return postArr.count+1;
        
    }
    else
    {
        collectionV.userInteractionEnabled=false;
         return 0;
    }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    else
    {
        ...
        NSString *st1= [dict valueForKey:@"location"];
        [locationlbl setText:st1];
        ...
        timelbl.textColor=[UIColor purpleColor];
        timelbl.backgroundColor=[UIColor clearColor];
        NSString *st2= [AppDelegate HourCalculation:[dict valueForKey:@"time"]];
        [timelbl setText:st2];
        ...
        CGRect labelFrame1;
        labelFrame1= CGRectMake (65, locationlbl.frame.origin.y+location.frame.size.height+3, self.view.frame.size.width-70, requiredHeight.size.height+2);
        STTweetLabel *labell = [[STTweetLabel alloc] initWithFrame:labelFrame1];
        labell.textColor=[UIColor grayColor];
        [labell setFont:myFont1];
        labell.lineBreakMode=NSLineBreakByWordWrapping;
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    return 50+requiredHeight.size.height+h+3+z;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [celll.userprofileButton addTarget:self action:@selector(userprofileButton_action:) forControlEvents:UIControlEventTouchUpInside];
    celll.userprofileButton.tag=indexPath.section;
...
//    }
    ...
    if([screenName isEqualToString:@"home"])
    {
        ...
        {
            if(postArr.count>0)
            [collectionV setContentOffset:CGPointMake(0,-0.5) animated:YES];
        }
        else
        {
            if(postArr.count>0)
                   ...
                   completionHandler:^(NSArray *placemarks, NSError *error)
     {
         ...
         [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
             ...
             if (JSONdata != nil) {
                 ...
                 [self searchNearestPlacesResult:JSON];
             ...
             [self searchNearestPlacesResult:nil];
