...
@implementation userfollowerView
...
//    [api_obj getFollowerList:@selector(getFollowerListResult:) tempTarget:self : followingID];
    
    
    NSString *urlString=[NSString stringWithFormat:@"%@/GetFollowers/%@/%@/%@/%@",CONNECTURL,userid,followingID,@"0",@"200"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (JSONdata != nil) {
            ...
            [self getFollowerListResult:JSON];
        ...
        [self getFollowerListResult:nil];
...
-(void)getFollowerListResult:(NSDictionary *)dict_Response
{
    NSLog(@"%@",dict_Response);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
if([[dict valueForKey:@"status"]  isEqual: @"approved"])
{
...
//    [api_obj follow_user:@selector(follow_userResult:) tempTarget:self : friendId :st];
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@/FollowUser/%@/%@/%@",CONNECTURL,userid,friendId,st];
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText
{
    if(![searchText  isEqual: @""])
    {
        ...
        api_obj=[[APIViewController alloc]init];
        [api_obj FollowerSearch:@selector(searchresult:) tempTarget:self :followingID :searchText];
